...
public class LikeAnyOperator implements Operator {
    @Override
    public String getName() {
        return OperatorEnum.likeany.name();
    }
    ...
    public void doOperate(SearchColumn s, StringBuilder sb) {
        sb.append(" array_to_string(").append(s.getUnderlineColumnKey()).append(", '') like any (ARRAY[");
